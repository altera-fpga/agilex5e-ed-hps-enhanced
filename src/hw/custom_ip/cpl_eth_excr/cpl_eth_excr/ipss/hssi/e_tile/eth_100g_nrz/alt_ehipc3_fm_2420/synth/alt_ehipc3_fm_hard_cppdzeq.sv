...
module alt_ehipc3_fm_hard_cppdzeq
...
assign elane_ehip_shared_clk            = {LANES6{o_ehip_clk}};
  ...
  assign rx_parallel_data[6*80-1:4*80] = {LANES2{78'b0}};
                ...
                eth_100g_nrz_alt_ehipc3_fm_xcvrnphy_fme_2420_atrbzsy altera_xcvr_native_inst (
...
// ---------------------------------------------------------------------------------------------------------------------------------
		   ...
		   // copied from alvin
                ...
                eth_100g_nrz_alt_ehipc3_fm_xcvrnphy_fme_2420_atrbzsy
       #(
         .hssi_rsfec_topology(topology)
       )
