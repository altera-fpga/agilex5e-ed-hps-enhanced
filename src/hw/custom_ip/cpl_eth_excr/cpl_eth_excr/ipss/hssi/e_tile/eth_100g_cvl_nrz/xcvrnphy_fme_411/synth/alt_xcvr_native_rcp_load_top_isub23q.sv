...
module alt_xcvr_native_rcp_load_top_isub23q
...
#(
  ...
  localparam ROM_ADD_WIDTH = altera_xcvr_native_s10_functions_h::clogb2_alt_xcvr_native_s10(alt_xcvr_native_rcp_load_rom_params_isub23q::rom_depth -1 ); //Maximum ROM address width

  localparam ROM_DATA_WIDTH = alt_xcvr_native_rcp_load_rom_params_isub23q::rom_data_width;
  ...
  alt_xcvr_native_rcp_load_rom_isub23q #(
  ...
  alt_xcvr_native_rcp_load_ctrl_isub23q #(
    .ROM_ADD_WIDTH       (ROM_ADD_WIDTH           ),
    .ROM_DATA_WIDTH      (ROM_DATA_WIDTH     ),
